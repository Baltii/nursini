    ...
    return (
      ...
      <Flex justifyContent="center">
        <Popover placement="bottom" isLazy>
          ...
          <PopoverContent _focus={{ boxShadown: 'none' }} w={'400px'} marginRight={'4'} >
            <PopoverArrow />
            <PopoverCloseButton />
                ...
                <TabPanels>
                  <TabPanel>
                    <Table>
                        <Tbody>
                            <Tr>
                                <Button w={'100%'} h={'100%'} p={'2'} onClick={onOpen}>
                                    <Stack direction={'row'} spacing={2} align={'center'} w={'100%'}>
                                        <Avatar
                                            src={'https://avatars0.githubusercontent.com/u/1164541?v=4'}
                                            alt={'Author'}
                                        />
                                        <Stack direction={'column'} spacing={0} fontSize={'sm'} align={'start'}>
